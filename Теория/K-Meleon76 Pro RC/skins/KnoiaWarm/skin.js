...
pref("kmeleon.toolband.Bookmarks.index", 1);
pref("kmeleon.toolband.Bookmarks.size", 625);
pref("kmeleon.toolband.Bookmarks.visibility", true);

pref("kmeleon.toolband.&Search Buttons.break", 0);
pref("kmeleon.toolband.&Search Buttons.index", 2);
...
pref("kmeleon.toolband.&Search+.index", 2);
...
pref("kmeleon.toolband.Extensions Manager.index", 3);
...
pref("kmeleon.toolband.AdBlock Plus (ABP7).index", 4);
...
pref("kmeleon.toolband.KMrestart2.index", 5);
...
pref("kmeleon.toolband.&Main Bar.index", 6);
...
pref("kmeleon.toolband.&Zoom Buttons.index", 7);
...
pref("kmeleon.toolband.&Go Buttons.index", 9);
...
pref("kmeleon.toolband.SearchBar Ext.index", 10);
...
pref("kmeleon.toolband.Throbber.index", 11);
...
pref("kmeleon.toolband.Mail/&News Buttons.index", 12);
...
pref("kmeleon.toolband.&Privacy Bar.index", 13);
